...
<body classname="snippet-body" data-new-gr-c-s-check-loaded="14.1058.0" data-gr-ext-installed="">
                ...
                <div class="card ">
                    ...
                    <form role="form" method="post">
                                    <div class="form-group"> <label >
                                            <h6>User Email</h6>
                                        </label> <input type="text" name="username" placeholder="User Email" required="" class="form-control "> </div>
                                    <div class="form-group"> <label >
                                            <h6>Password</h6>
                                        </label>
    ...
    padding: 10px;"> Not a member? <a href="./signup.php">Signup now</a></div>
                                        </div>
